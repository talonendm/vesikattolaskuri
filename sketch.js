...
function setup() {
  ...
  radioreikavali = createRadio();
  radioreikavali.option('0', 'ei reikiä tuuletusrimassa'); // https://www.aulislundell.fi/naytatuoteperhe/HTL+Ruode/26083
  radioreikavali.option('1', '150mm väli');
  radioreikavali.option('2', '100mm väli');
  radioreikavali.option('3', '50mm väli');
  radioreikavali.style('width', '900px');
  radioreikavali.selected('1');
  radioreikavali.position(20, 490);
  ...
  let linkkivastuu = createA('https://github.com/talonendm/vesikattolaskuri/blob/gh-pages/README.md', 'info');
  linkkivastuu.position(1040, 28);
...
function draw() {
  ...
  tuuletusrimareikavali = radioreikavali.value();
  if (tuuletusrimareikavali == 1) {
    tuuletusrimareikavali = 150;
  } else if (tuuletusrimareikavali == 2) {
    tuuletusrimareikavali = 100;
  } else if (tuuletusrimareikavali == 3) {
    tuuletusrimareikavali = 50;
  }
...
function PiirraTuuletusrima() {
  if (tuuletusrimakoko != 0) {
    if (tuuletusrimakoko == 1) {
      ...
      tuuletusrimaH = 32;
      tuuletusrimaL = 100;
    } else if (tuuletusrimakoko == 3) {
      tuuletusrimaH = 45;
      tuuletusrimaL = 60;
    } else if (tuuletusrimakoko == 4) {
      tuuletusrimaH = 25;
      tuuletusrimaL = 50;
...
function PiirraVaakaruode() {
  ...
  if (checkboxTuulettuvaruode.checked()) {
    ...
    if (tuuletusrimareikavali > 0) {
      ...
      for (i = reika_alkualoitus; i < reikia_n; i = i + 1) {
